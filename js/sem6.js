function dothis(){
    ...
    switch(option.value){
      case "C":
        ...
        var third_subject_credit_res = cal(document.querySelector('#inputsidebar3').value,4);
    ...
    case "E":
      ...
      third_subject_credit_res = cal(document.querySelector('#inputsidebar11').value,4);
      ...
      sixth_subject_credit_res = cal(document.querySelector('#inputsidebar14').value,2);
      seventh_subject_credit_res = cal(document.querySelector('#inputsidebar15').value,2);
      eigth_subject_credit_res = cal(document.querySelector('#inputsidebar16').value,2);
      total = first_subject_credit_res+second_subject_credit_res+third_subject_credit_res+fourth_subject_credit_res+fifth_subject_credit_res+sixth_subject_credit_res+seventh_subject_credit_res+eigth_subject_credit_res;
        break;
    case "M":
        first_subject_credit_res = cal( document.querySelector('#inputsidebar17').value,4);
        second_subject_credit_res = cal(document.querySelector('#inputsidebar18').value,4);
        third_subject_credit_res = cal(document.querySelector('#inputsidebar19').value,4);
        fourth_subject_credit_res = cal(document.querySelector('#inputsidebar20').value,3);
        fifth_subject_credit_res = cal(document.querySelector('#inputsidebar21').value,3);
        sixth_subject_credit_res = cal(document.querySelector('#inputsidebar22').value,2);
        seventh_subject_credit_res = cal(document.querySelector('#inputsidebar23').value,2);
        eigth_subject_credit_res = cal(document.querySelector('#inputsidebar24').value,2);
        total = first_subject_credit_res+second_subject_credit_res+third_subject_credit_res+fourth_subject_credit_res+fifth_subject_credit_res+sixth_subject_credit_res+seventh_subject_credit_res+eigth_subject_credit_res;
          break;

    case "L":
        first_subject_credit_res = cal( document.querySelector('#inputsidebar25').value,4);
        second_subject_credit_res = cal(document.querySelector('#inputsidebar26').value,4);
        third_subject_credit_res = cal(document.querySelector('#inputsidebar27').value,4);
        fourth_subject_credit_res = cal(document.querySelector('#inputsidebar28').value,3);
        fifth_subject_credit_res = cal(document.querySelector('#inputsidebar29').value,3);
        sixth_subject_credit_res = cal(document.querySelector('#inputsidebar30').value,2);
        seventh_subject_credit_res = cal(document.querySelector('#inputsidebar31').value,2);
        eigth_subject_credit_res = cal(document.querySelector('#inputsidebar32').value,2);
        total = first_subject_credit_res+second_subject_credit_res+third_subject_credit_res+fourth_subject_credit_res+fifth_subject_credit_res+sixth_subject_credit_res+seventh_subject_credit_res+eigth_subject_credit_res;
           break;
    case "I":
        first_subject_credit_res = cal( document.querySelector('#inputsidebar33').value,4);
        second_subject_credit_res = cal(document.querySelector('#inputsidebar34').value,4);
        third_subject_credit_res = cal(document.querySelector('#inputsidebar35').value,4);
        fourth_subject_credit_res = cal(document.querySelector('#inputsidebar36').value,3);
        fifth_subject_credit_res = cal(document.querySelector('#inputsidebar37').value,3);
        sixth_subject_credit_res = cal(document.querySelector('#inputsidebar38').value,2);
        seventh_subject_credit_res = cal(document.querySelector('#inputsidebar39').value,2);
        eigth_subject_credit_res = cal(document.querySelector('#inputsidebar40').value,2);
        total = first_subject_credit_res+second_subject_credit_res+third_subject_credit_res+fourth_subject_credit_res+fifth_subject_credit_res+sixth_subject_credit_res+seventh_subject_credit_res+eigth_subject_credit_res;
           break;
    case "T":
        first_subject_credit_res = cal( document.querySelector('#inputsidebar40').value,4);
        second_subject_credit_res = cal(document.querySelector('#inputsidebar42').value,4);
        third_subject_credit_res = cal(document.querySelector('#inputsidebar43').value,4);
        fourth_subject_credit_res = cal(document.querySelector('#inputsidebar44').value,3);
        fifth_subject_credit_res = cal(document.querySelector('#inputsidebar45').value,3);
        sixth_subject_credit_res = cal(document.querySelector('#inputsidebar46').value,2);
        seventh_subject_credit_res = cal(document.querySelector('#inputsidebar47').value,2);
        eigth_subject_credit_res = cal(document.querySelector('#inputsidebar48').value,2);
        total = first_subject_credit_res+second_subject_credit_res+third_subject_credit_res+fourth_subject_credit_res+fifth_subject_credit_res+sixth_subject_credit_res+seventh_subject_credit_res+eigth_subject_credit_res;
            break;
    ...
    document.querySelector('#btn_re').addEventListener('click',() =>{
        ...
        document.querySelector('#inputsidebar47').value='';
        document.querySelector('#inputsidebar48').value='';  
    })}